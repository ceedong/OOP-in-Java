...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		map2 =  new UnfoldingMap(this, 420, 50, 350, 500, provider);// TODO: Add code here that creates map2 
		map2.zoomAndPanTo(zoomLevel, new Location(117.5f, 43.7f));// Then you'll modify draw() below
