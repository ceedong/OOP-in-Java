	...
	// TODO: Add the method:
	  private void sortAndPrint(int numToPrint) {
		...
		if (numToPrint > array.length) {
			...
			System.out.println("Actually the number is larger than the file's length. So rather"
					+ "I just print out the whole file here.");
		} 
		for (int i = 0; i < numToPrint; i++) {
		System.out.println(array[i].getMagnitude());
			}
