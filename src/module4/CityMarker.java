...
public class CityMarker extends SimplePointMarker {
	...
	public void draw(PGraphics pg, float x, float y) {
		...
		pg.fill(255, 0, 0);// TODO: Add code to draw a triangle to represent the CityMarker
		pg.triangle(7+x, 19+y, 15+x, 5+y, 22+x, 19+y);// HINT: pg is the graphics object on which you call the graphics
