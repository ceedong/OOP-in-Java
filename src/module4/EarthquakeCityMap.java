...
public class EarthquakeCityMap extends PApplet {
	...
	private void addKey() {	
		...
		fill(color(255, 0, 0));
		triangle(50, 129, 58, 115, 65, 129);
		fill(color(255, 255, 255));
		ellipse(57, 145, 15, 15);
		fill(color(255, 255, 255));
		rect(50, 160, 15, 15);
		fill(color(255, 255, 0));
		ellipse(57, 240, 15, 15);
		fill(color(0, 0, 255));
		ellipse(57, 260, 15, 15);
		fill(color(0, 255, 0));
		ellipse(57, 280, 15, 15);
		
		fill(0, 0, 0);
		text("City Marker", 75, 120);
		text("Land Quake", 75, 143);
		text("Ocean Quake", 75, 167);
	...
	private void printQuakes() 
	{
		...
		for (Marker cm : countryMarkers) {
			...
			if (quakeCounter != 0) {
			System.out.print(name + ":" + quakeCounter + "\n");
			}
		}
		int oceanCounter = 0;
		for (Marker eq : quakeMarkers) {
			...
			System.out.print("OCEAN QUAKES: " + oceanCounter);
